...
<nav id="sidebar">
  ...
  <div class="sidebar-menu-scroll">
    <div style="padding: 8px 0;">
      <!-- <div class="nav-label">ປະເທດ</div> -->
      <a href="<?= BASE_URLS ?>" class="nav-item"><span class="nav-text">Dashboard</span></a>
      <a href="<?= BASE_URLS ?>korea/" class="nav-item active"><img src="https://flagcdn.com/w40/kr.png" class="nav-flag"><span class="nav-text">Korea</span></a>
    ...
    <div class="system-menu-tabs">
      ...
      <div class="dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-end custom-dropdown-menu">
          <li><a class="dropdown-item" href="<?= BASE_URLSS ?>list_employer.php">Employers</a></li>
          <li><a class="dropdown-item" href="<?= BASE_URLSS ?>">Associations</a></li>
          <li><a class="dropdown-item" href="<?= BASE_URLSS ?>list_agency.php">Agency</a></li>
          <li><a class="dropdown-item" href="<?= BASE_URLSS ?>list_pro_korea.php">Province Korea</a></li>
          <li><a class="dropdown-item" href="<?= BASE_URLSS ?>list_dis_korea.php">District Korea</a></li>
        </ul>
      </div>
      <div class="dropdown">
        <button class="tab-btn dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
