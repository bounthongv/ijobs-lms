...
document.getElementById('labor_fee').addEventListener('input', function (e) {
    let raw = e.target.value;
        ...
        let diff = formattedValue.length - raw.length;
        e.target.setSelectionRange(cursorPos + diff, cursorPos + diff);
});
document.getElementById('check_up').addEventListener('input', function (e) {
    let raw = e.target.value;
        let cursorPos = e.target.selectionStart;
        let value = raw.replace(/[^\d.]/g, '');
        let dotIndex = value.indexOf('.');
...
document.getElementById('check_up2').addEventListener('input', function (e) {
    let raw = e.target.value;
        let cursorPos = e.target.selectionStart;
        let value = raw.replace(/[^\d.]/g, '');
        let dotIndex = value.indexOf('.');
...
document.getElementById('check_up3').addEventListener('input', function (e) {
    let raw = e.target.value;
        let cursorPos = e.target.selectionStart;
        let value = raw.replace(/[^\d.]/g, '');
        let dotIndex = value.indexOf('.');
