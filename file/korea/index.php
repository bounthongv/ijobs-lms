...
<!-- ===== ຫົວ Dashboard ເກົາຫຼີ ===== -->
<div class="kr-header">
  <div class="kr-title-wrap">
    <img src="https://flagcdn.com/w80/kr.png" class="kr-flag" alt="Korea">
    <div>
      <h5 class="kr-title">Dashboard Korea</h5>
  ...
  <span class="badge px-3 py-2 fw-semibold" style="background:#fef2f2; color:#991b1b; font-size:13px;">
    <i class="bi bi-geo-alt-fill me-1"></i>ສາທາລະນະລັດ Korea
  </span>
</div>
