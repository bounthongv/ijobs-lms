...
<nav id="sidebar">
  ...
  <div class="sidebar-menu-scroll">
    <div style="padding: 8px 0;">
      ...
      <!-- ===== จบเมนู Data List ===== -->
      <a href="<?= BASE_URLS ?>user/" class="nav-item  active"><img src="https://th.bing.com/th/id/R.b2b34517339101a111716be1c203f354?rik=e5WHTShSpipi3Q&pid=ImgRaw&r=0" class="nav-flag"><span class="nav-text">Users</span></a>
    </div>
  </div>
...
<div id="main-content">
  <header class="topbar">
    ...
    <div class="system-menu-tabs">
      <a class="tab-btn" href="index.php" aria-expanded="false">
          ໜ້າຫຼັກ 
        </a>

      <div class="dropdown">
        <button class="tab-btn dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
          ການກຳນົດສິດນຳໃຊ້ <i class="bi bi-chevron-down"></i>
        </button>
        <ul class="dropdown-menu dropdown-menu-end custom-dropdown-menu">
          <li><a class="dropdown-item" href="<?= BASE_URLSS ?>list_user.php">ລາຍການຜູ້ໃຊ້ລະບົບ</a></li>
          <li><a class="dropdown-item" href="<?= BASE_URLSS ?>list_user_following.php">ການຕິດຕາມການນຳໃຊ້</a></li>
          <li><a class="dropdown-item" href="<?= BASE_URLSS ?>list_user_follower.php">ການຕິດຕາມການປະຕິບັດ</a></li>
        </ul>
      </div>
    </div>
  </header>
