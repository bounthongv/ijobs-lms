...
<nav id="sidebar">
  ...
  <div class="sidebar-menu-scroll">
    <div style="padding: 8px 0;">
      ...
      <a href="<?= BASE_URLS ?>china/" class="nav-item active"><img src="https://flagcdn.com/w40/cn.png" class="nav-flag"><span class="nav-text">China</span></a>
    ...
    <div class="system-menu-tabs">
      ...
      <div class="dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-end custom-dropdown-menu">
          ...
          <li><a class="dropdown-item" href="<?= BASE_URLSS ?>">Province China</a></li>
          <li><a class="dropdown-item" href="<?= BASE_URLSS ?>">District China</a></li>
        </ul>
      </div>
      <div class="dropdown">
        <button class="tab-btn dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
