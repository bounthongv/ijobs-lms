<div class="modal-overlay" id="modalOverlayEdit" onclick="closeOnOverlayEdit(event)">
  <div class="modal-box">
      ...
      <div class="modal-body">
        <form action="" id="edit_dis"> 
          <input type="hidden" name="old_dis_id" id="old_dis_id">
        <div class="form-group">
          <label class="form-label">
             District ID
          </label>
          <input type="text" name="dis_id" id="edit_dis_id" class="form-control-custom">
        </div>
        <div class="form-group">
          <label class="form-label">
            Province
        ...
        <div class="form-group">
          ...
          <input type="text" name="dis_name_lao" id="edit_dis_name_lao" class="form-control-custom">
        </div>
        ...
        <div class="form-group">
          ...
          <input type="text" name="dis_name" id="edit_dis_name" class="form-control-custom">
        </div>
      ...
      <div class="modal-foot">
        ...
        <button type="button" class="btn-save" id="e_btn_dis">
...
function openModalEdit(userData) {
    ...
    document.getElementById('old_dis_id').value = userData.dis_id || '';
    document.getElementById('edit_dis_id').value = userData.dis_id || '';
    document.getElementById('edit_dis_name_lao').value = userData.dis_name_lao || '';
    document.getElementById('edit_dis_name').value = userData.dis_name || '';
