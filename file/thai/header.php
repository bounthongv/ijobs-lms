<?php 
  ...
  if (!defined('BASE_URLS')) {
    ...
    define('BASE_URLSS', 'https://job.apis.com.la/file/thai/');
  }
?>
<!DOCTYPE html>
<html lang="lo">
...
<nav id="sidebar">
  ...
  <div class="sidebar-menu-scroll">
    <div style="padding: 8px 0;">
      ...
      <a href="<?= BASE_URLS ?>thai/" class="nav-item active"><img src="https://flagcdn.com/w40/th.png" class="nav-flag"><span class="nav-text">Thailand</span></a>
    ...
    <div class="system-menu-tabs">
      ...
      <div class="dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-end custom-dropdown-menu">
          ...
          <li><a class="dropdown-item" href="<?= BASE_URLSS ?>">Province Thailand</a></li>
          <li><a class="dropdown-item" href="<?= BASE_URLSS ?>">District Thailand</a></li>
        </ul>
      </div>
      <div class="dropdown">
        <button class="tab-btn dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
